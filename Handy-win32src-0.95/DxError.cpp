...
char* DXAppErrorToString(HRESULT error)
{
    switch(error) {
        ...
        case DDERR_OUTOFMEMORY:
            return "Not enough memory to perform the operation.\0";
//            return "DirectDraw does not have enough memory to perform the operation.\0";
		...
		case DSERR_ALREADYINITIALIZED:
			return "The object is already initialized.\0";
		case DSERR_BADFORMAT:
			return "The specified wave format is not supported.\0";
		case DSERR_BUFFERLOST:
			return "The buffer memory has been lost and must be restored.\0";
		case DSERR_CONTROLUNAVAIL:
			return "The control (volume, pan, and so forth) requested by the caller is not available.\0";
//		case DSERR_GENERIC:
//			return "An undetermined error occurred inside the DirectSound subsystem.\0";
		case DSERR_INVALIDCALL:
			return "This function is not valid for the current state of this object.\0";
//		case DSERR_INVALIDPARAM:
//			return "An invalid parameter was passed to the returning function.\0";
		case DSERR_NOAGGREGATION:
			return "The object does not support aggregation.\0";
		case DSERR_NODRIVER:
			return "No sound driver is available for use.\0";
		case DSERR_NOINTERFACE:
			return "The requested COM interface is not available.\0";
		case DSERR_OTHERAPPHASPRIO:
			return "Another application has a higher priority level, preventing this call from succeeding\0";
//		case DSERR_OUTOFMEMORY:
//			return "The DirectSound subsystem could not allocate sufficient memory to complete the caller's request.\0";
		case DSERR_PRIOLEVELNEEDED:
			return "The caller does not have the priority level required for the function to succeed.\0";
		case DSERR_UNINITIALIZED:
			return "The IDirectSound::Initialize method has not been called or has not been called successfully before other methods were called.\0";
