...
/* SDL declarations */
extern SDL_Surface *HandyBuffer=0; // Our Handy/SDL display buffer
extern SDL_Surface *mainSurface=0; // Our Handy/SDL primary display
...
void ShowMenu(MENU *menu)
{
   ...
   for(i = 0; i < menu->itemNum; i++, mi++) {
      ...
      if(menu->itemCur == i) fg_color = COLOR_ACTIVE_ITEM;
      else fg_color = COLOR_INACTIVE_ITEM;
